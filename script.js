...
// 배포 후 받은 URL로 교체하세요
// =====================================================
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzAFSJnuhbVzOXEVfpU2_IF5nO4uk_Xh1mWHSZgCwqS4Mmq6dT3JEIofFpJR3GAnzSihw/exec";
...
// =====================================================================
const FIXED_STORIES = {
  // ── 미국 (United States) 섹션 내에 추가 ──────────────────────────────────
  "미국 Virginia": `1865년 4월, 미국 남북전쟁이 막바지에 다다르자 남부연합의 수도였던 버지니아주 리치먼드가 함락될 위기에 처했어요. 남부연합의 유일한 대통령이었던 제퍼슨 데이비스는 정부 문서와 보물을 챙겨 황급히 기차를 타고 도망쳐야 했답니다. 그는 끝까지 게릴라전을 벌이며 저항하려 했지만, 결국 한 달 뒤 조지아주에서 연방군에게 체포되고 말았어요. 이 버지니아 탈출 사건은 치열했던 남북전쟁이 사실상 북부의 승리로 끝났음을 상징하는 역사의 한 장면이 되었답니다.`,
  "독일 Bayern": `1923년 11월 8일, 뮌헨의 뷔르거브로이켈러 맥주홀에서 아돌프 히틀러가 쿠데타를 선언했어요. 바로 그 유명한 '맥주홀 폭동(Beer Hall Putsch)'이랍니다. 히틀러는 권총을 천장에 쏘며 "국민혁명이 시작됐다!"고 외쳤지만, 다음 날 경찰에게 진압되어 체포되고 말았어요. 하지만 감옥 안에서 《나의 투쟁》을 집필하며 오히려 전국적인 유명인사가 되었고, 10년 후 결국 독일의 권력을 손에 쥐게 됐답니다.`,
